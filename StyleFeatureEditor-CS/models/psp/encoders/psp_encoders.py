...
class Inverter(nn.Module):
    def __init__(self, n_styles=18, opts=None):
        ...
        # ---- NEW: adapt to StyleGAN channel_multiplier ----
        if opts.channel_multiplier == 1:
            style_feat_channels = 256
        else:
            style_feat_channels = 512

        w_feat_channels = 512
        in_channels = style_feat_channels + w_feat_channels
        # ---------------------------------------------------

        self.fuser = ContentLayerDeepFast(6, in_channels, style_feat_channels)



# def styles_per_block(n_styles):
#     """
#     StyleGAN2: 2 styles per resolution.
#     n_styles = 2 * log2(resolution) - 2
#     """
#     assert n_styles % 2 == 0
#     return [2] * (n_styles // 2)

...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--n_layer_disc', default=2, type=int, help='number of branch layers in FN')
		self.parser.add_argument('--disc_type', default='global', type=str, help='global or indenpendent')
		self.parser.add_argument('--mi_loss_type', default='logit', type=str)
		...
		# # arguments for mlp mapping from c to s
		self.parser.add_argument('--n_layer_c2s', default=12, type=int)
		self.parser.add_argument('--train_c2s_mlp',  action="store_true")   
		self.parser.add_argument('--train_c2s_interval',  default=1, type=int) 
		self.parser.add_argument('--w_adv_lambda',  default=1.0, type=float)
		self.parser.add_argument('--c2s_learning_rate',  default=0.01, type=float)
		 
		# self.parser.add_argument('--directional_align_dim', default=1, type=int)
		# self.parser.add_argument('--orthogonality_lambda', default=1.0, type=float)
		...
		self.parser.add_argument('--adv_c2s_lambda', default=1.0, type=float, help='l1 loss for silent factor of target')
		...
		self.parser.add_argument('--c2s_loss_type', default='l2', type=str, help='type of norm forcing sbg toward zeros')
		...
		self.parser.add_argument('--c2s_checkpoint_path', default=None, type=str, help='Path to c2smlp model checkpoint')
		...
		self.parser.add_argument('--w_mi_lambda', default=1.0, type=float)

...
from models.e4e_models.encoders import psp_encoders
from models.e4e_models.stylegan2.model import Generator
...
class pSp(nn.Module):
    ...
    def load_weights(self):
        if self.opts.e4e_checkpoint_path is not None:
            ...
            ckpt = torch.load(self.opts.e4e_checkpoint_path, map_location='cpu')

	...
	def train(self):
		...
		while self.global_step < self.opts.max_steps:
			...
			for batch_idx, (batch_bg, batch_t) in enumerate(zip(self.train_bg_dataloader, self.train_t_dataloader)):
				...
				latent_bg_c, latent_bg_s = self.cs_mlp_net(w_bg_pSp)
				latent_t_c, latent_t_s = self.cs_mlp_net(w_t_pSp) 
				rec_x_bg = self.pSp_net.forward(latent_bg_c + latent_bg_s, input_code=True, randomize_noise=True, recon_modle=True)

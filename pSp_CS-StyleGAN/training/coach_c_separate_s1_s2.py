...
class Coach_csmlp:
	...
	def calc_latent_loss(self, latent_bg_c, latent_bg_s1, latent_bg_s2, latent_t_c, latent_t_s1, latent_t_s2, w_bg_pSp, w_t_pSp):
		...
		if self.opts.sbg_lambda > 0:
			...
			loss_silent_1 = F.mse_loss(latent_bg_s2, torch.zeros_like(latent_bg_s2).to(self.device))
			loss_silent_2 = F.mse_loss(latent_t_s1, torch.zeros_like(latent_t_s1).to(self.device))
